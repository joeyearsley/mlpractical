...
train_dp = MNISTDataProvider(dset='train', batch_size=100, max_num_batches=1000, randomize=True, augmentation = 4)
...
for layer in xrange(0,1):
    ...
    shelve_r['siAugExpF'+str(layer)] = (tr_stats, valid_stats, (tst_cost, tst_accuracy))
